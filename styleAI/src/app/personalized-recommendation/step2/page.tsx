            ...
            <div className="flex flex-col items-center">
              ...
              <div className="w-full bg-gray-100 p-6 rounded-lg">
                ...
                <p className="text-gray-700 mb-4">
                  We are currently analyzing your photo to provide personalized
                  style recommendations. This process may take a few moments.
                </p>
                ...
                <p className="text-sm text-gray-500 mb-6">
                  ...
                  body type to determine the best style recommendations for you.
                </p>

...
export function FullscreenPopup({ report, onClose }: FullscreenPopupProps) {
  ...
  return (
    <motion.div
      ...
      onClick={onClose}>
      <motion.div
        className="relative my-4 w-full max-w-4xl rounded-xl bg-white p-6 shadow-2xl"
        ...
        <motion.h2
          className="mb-6 font-playfair text-3xl font-bold text-gray-800"
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <motion.div
            ...
            <h3 className="mb-3 font-medium text-lg">Your Image</h3>
          ...
          <motion.div
            ...
            <h3 className="mb-3 font-medium text-lg">Best Style Match</h3>
            <div className="overflow-hidden rounded-lg shadow-md">
              {report.bestFitImage ? (
                <img
        ...
        <motion.div
          ...
          <h3 className="mb-3 font-medium text-xl">Detailed Analysis</h3>
        ...
        <motion.div
          ...
          <h3 className="mb-4 font-medium text-lg">Style Recommendations</h3>
